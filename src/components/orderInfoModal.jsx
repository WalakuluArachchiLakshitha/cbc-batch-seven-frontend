...
export default function OrderModal({
  ...
  "
					...
					<div className="flex items-center gap-2">
						<button
							onClick={() => {
								if (!window.confirm("Are you sure you want to permanently delete Order #" + selectedOrder.orderID + "?")) return;
							...
							className="rounded-2xl bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700 transition"
						>
							Delete
						</button>
						<button
