  ...
  return (
    <div className="w-full min-h-screen bg-primary mt-20">
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about our mission to provide natural, sustainable, and cruelty-free beauty products."
        />
      </Helmet>
      ...
      <section className="relative h-[400px] flex items-center justify-center bg-secondary text-white overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6">
          ...
          <p className="text-xl max-w-2xl mx-auto opacity-90">
            Crafting natural beauty solutions with passion and integrity since
            2020.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-secondary/70 leading-relaxed">
              We believe that true beauty comes from within and is enhanced by
              nature's finest ingredients. Our mission is to provide
              high-quality, sustainable, and effective cosmetic products that
              empower you to feel confident in your own skin.
            </p>
            <p className="text-lg text-secondary/70 leading-relaxed">
              Every product in our collection is carefully formulated with
              ethically sourced ingredients, ensuring that you receive the best
              care without compromising on your values.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl bg-primary/30 hover:bg-primary/50 transition-colors">
              ...
              <p className="text-secondary/70">
                We prioritize plant-based, organic ingredients free from harmful
            ...
            <div className="text-center p-8 rounded-2xl bg-primary/30 hover:bg-primary/50 transition-colors">
              ...
              <p className="text-secondary/70">
                Adding beauty shouldn't cost a life. All our products are 100%
            ...
            <div className="text-center p-8 rounded-2xl bg-primary/30 hover:bg-primary/50 transition-colors">
              ...
              <p className="text-secondary/70">
                From sourcing to packaging, we are committed to reducing our
