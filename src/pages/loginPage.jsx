						...
						<div className="rounded-3xl backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl p-8 sm:p-10">
							...
							<div className="space-y-5">
								...
								<div className="flex items-center justify-end text-sm">
									<Link
										to="/forgot-password"
										className="text-primary/90 hover:underline underline-offset-4"	
								...
								{import.meta.env.VITE_GOOGLE_CLIENT_ID && (
									<>
										<div className="relative text-center my-2">
											...
											<span className="relative bg-transparent px-3 text-xs text-primary/70">or continue with</span>
										</div>
										<button
											onClick={() => googleLogin()}
											className="w-full h-11 rounded-xl bg-white text-secondary font-semibold shadow-md hover:bg-gray-50 active:scale-[0.99] transition flex items-center justify-center gap-3"
										>
