									...
									{orders.map((item) => (
										...
										>
											<div className="flex justify-between items-start">
												<div>
													<span className="text-xs font-mono text-secondary/60 block mb-1">#{item.orderID}</span>
													<h3 className="font-semibold text-secondary">{item.customerName}</h3>
												</div>
											...
											<div className="flex justify-between items-center mt-1">
												<span className="text-sm text-secondary/60">{item.email}</span>
												<span className="font-bold text-accent text-lg">LKR {item.total.toFixed(2)}</span>
											</div>
										</div>
									))}
									{orders.length === 0 && (
