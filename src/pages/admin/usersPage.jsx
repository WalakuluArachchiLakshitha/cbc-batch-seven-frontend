...
// function UserDeleteConfirm(props) {
// 	const email = props.user.email;
// 	const close = props.close;
// 	const refresh = props.refresh;
...
// 		const token = localStorage.getItem("token");
// 		axios
// 			.delete(import.meta.env.VITE_API_URL + "/api/users/" + email, {
// 				headers: {
// 					Authorization: `Bearer ${token}`
// 				}
// 			}).then(() => {
...
// 					Are you sure you want to permanently delete the user: {email}?
// 				</p>
// 				<div className="flex gap-[40px]">
// 					<button
// 						onClick={close}
...
// 															}}
// 															className="w-[30px] h-[30px] rounded-full cursor-pointer text-white bg-red-600 hover:bg-red-700 flex items-center justify-center"
// 															title="Delete user">
