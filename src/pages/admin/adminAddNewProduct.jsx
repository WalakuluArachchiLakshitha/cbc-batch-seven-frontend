                ...
                <div className="flex items-center justify-between gap-3 border-t border-accent/20 px-6 py-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={addProduct}
                            disabled={isLoading}
                            className="rounded-full bg-accent/15 px-3 h-[40px] w-[100px] py-1 text-md flex justify-center items-center font-medium text-secondary ring-1 ring-accent/30 hover:border-accent hover:border-[2px] disabled:opacity-50"
                        >
