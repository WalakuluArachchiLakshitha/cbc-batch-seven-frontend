...
export default function ProductOverview() {
	...
	return (
		<div className="w-full lg:h-[calc(100vh-100px)] text-secondary bg-primary overflow-y-auto">
			...
			{showReviewModal && (
				...
				>
					<div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 p-8 relative animate-fadeIn">
						...
						<h3 className="text-2xl font-bold mb-6 text-secondary">Write a Review</h3>
